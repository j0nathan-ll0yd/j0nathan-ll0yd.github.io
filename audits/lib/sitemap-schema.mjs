// audits/lib/sitemap-schema.mjs -- pure-Node validation of the
// sitemaps.org 0.9 schemas (audits/vendor/{sitemap,siteindex}-0.9.xsd),
...
// XSDs by audits/__tests__/sitemap-schema-drift.test.ts, which re-derives them from
