// audits/__tests__/b2-validate-llms-txt.property.test.ts -- the llms.txt structural
...
//
// The rule catalog under audits/specs/llms-txt/ stays as the normative
...
// audits/__tests__/llms-txt-arbitraries.ts on purpose: the three pools there are frozen
