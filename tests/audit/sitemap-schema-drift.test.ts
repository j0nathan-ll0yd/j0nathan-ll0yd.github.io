// scripts/audit/lib/sitemap-schema.mjs transcribes the vendored sitemaps.org
...
import {CHANGEFREQ_VALUES, LOC_FACETS, PRIORITY_FACETS, PROFILES, SITEMAP_NS} from '../../scripts/audit/lib/sitemap-schema.mjs'

const __dirname = path.dirname(fileURLToPath(import.meta.url))
const vendorDir = path.join(__dirname, '..', '..', 'scripts', 'audit', 'vendor')
