// tests/audit/fixtures/validate-llms-txt.regenerated.mjs -- TEST FIXTURE, NOT
// PRODUCTION CODE.
//
...
// moves from './specs/load.mjs' (the file used to sit next to the validator in
// scripts/audit/) to the relative path from tests/audit/fixtures/. The
// validation logic is unchanged, so tests/audit/llms-differential.test.ts
// reproduces the divergence classes 0036 reported.
//
// A blind regeneration of validateLlmsTxt from the rule
// catalog (scripts/audit/specs/llms-txt/*.rule.json) plus its declared cases,
...
import {emit, rules} from '../../../scripts/audit/specs/load.mjs'
