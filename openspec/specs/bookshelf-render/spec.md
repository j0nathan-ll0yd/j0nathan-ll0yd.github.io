...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:5`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:11`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:17`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:23`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:29`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:35`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:41`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:47`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:53`.
...
Verified by `tests/behavioral/bookshelf-matrix.test.ts:59`.
